...
namespace HelpFinal.Areas.Administrator.Controllers
{
    ...
    public class TestimonialsController : Controller
    {
        ...
        public TestimonialsController(FinalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,TestimonialName,Collage,TestimonialDesc,Image,CreationDate,IsPublished,IsDeleted,UserId")] Testimonial testimonial)
        {
